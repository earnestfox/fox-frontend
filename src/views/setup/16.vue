<!-- User will be automatically brought to this screen by a text file present on HW 4 which informs fox to redirect the user to this page (state variable setup2)-->
<template>
    ...
    ProgressBar
      ...
      methods: {
          acknowledge(){
            ...
            store.commit('setDebug', `error reading setup CD Setup16-3: ${e}`)
            this.loading = false
            this.noCD = true
            })
          },
