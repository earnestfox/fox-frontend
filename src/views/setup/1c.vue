<template>
  ...
  <div v-else class="login">
    <header>
      ...
      <h2>If you are new to Fox, click the "Create New Wallet" button below.</h2>
    ...
    <div class="form_container">
        <form>
            <div class="checkbox_container">
                ...
                <label for="checkbox">I already have an Fox wallet.</label>
            </div>
        </form>
    ...
    methods: {
      install(){
        ...
        invoke('check_network').then((res) => {
          ...
          store.commit('setLoadMessage', `Initializing Fox...`)
