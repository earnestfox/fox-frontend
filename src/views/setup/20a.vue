<!-- User will be automatically brought to this screen by a text file present on HW 7 which informs fox to redirect the user to this page (state variable setup2)-->
...
export default {
  ...
  components: {
    ...
    methods: {
        ...
        .catch((e)=> {
          store.commit('setDebug', `error reading setup CD Setup20a-1: ${e}`)
          this.loading = false
          this.noCD = true
        })
        },
