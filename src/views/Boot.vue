<!-- this page conditionally renders if the user does not currently have any Fox HW inserted (in which case they are prompted to install Fox software)
